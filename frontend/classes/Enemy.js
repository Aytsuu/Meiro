...
//             this.position.x += 64 // Move one tile to the right
//         } else if (playerPosition.x < this.position.x) {
//             this.position.x -= 64 // Move one tile to the left
//         }

//         if (playerPosition.y > this.position.y) {
//             this.position.y += 64 // Move one tile down
//         } else if (playerPosition.y < this.position.y) {
//             this.position.y -= 64 // Move one tile up
//         }
//     }
